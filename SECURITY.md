...
If you find a security vulnerability in flappy-bird-demo, please report it through [GitHub's private vulnerability reporting](https://github.com/audreyfeldroy/flappy-bird-demo/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact chen.konturek@gmail.com for details.
